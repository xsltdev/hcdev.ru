...
![Автоматизированное окно кодирования изображений.](automating-1.png)
...
![В отчете об отзывчивых изображениях показано несоответствие размера/ширины.](automating-2.png)
...
![Отчет по отзывчивым изображениям с предлагаемыми размерами.](automating-3.png)
