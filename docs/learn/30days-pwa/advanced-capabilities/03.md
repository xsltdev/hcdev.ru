...
| **Sharing _from_ your application** | Learn how to share content directly from your PWA.                                                            |
| **Sharing _to_ your application**   | Prepare your PWA to receive shared content.                                                                   |
| **Related**                         | Look for other OS integrations throughout [Week 2: Advanced Capabilities](../advanced-capabilities/index.md). |
