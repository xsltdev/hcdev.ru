...
![Объектная модель доступности в Chrome.](headings-and-sections-1.png)
...
![Макет с верхним колонтитулом, тремя колонками и нижним колонтитулом](headings-and-sections-2.png)
