...
=== "Несемантическая разметка"
    ...
    ![Список узлов, все из которых являются ссылками или текстовыми литералами.](semantic-html-1.png)

=== "Семантическая разметка"

    Второй фрагмент кода. Список узлов с четкими обозначениями.

    ![Список узлов с четкими обозначениями.](semantic-html-2.png)
...
=== "Несемантическая разметка"
    ...
    ![Все текстовые узлы отображаются как статический текст.](semantic-html-3.png)

=== "Семантическая разметка"

    Второй фрагмент кода. Все текстовые узлы имеют описания.

    ![Все текстовые узлы имеют описания.](semantic-html-4.png)
