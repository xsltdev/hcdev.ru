...
![Первая страница этой страницы, включая хлебные крошки в верхней части, кнопку, показывающую оглавление этой страницы, и локальные навигации для серии.](navigation-1.png)
...
![Skip to Main button.](navigation-2.png)
...
<figure markdown>
![На узких экранах оглавление скрывается за кнопкой "На этой странице", которая переключает видимость навигации.](navigation-3.png)
...
<figure markdown>
![На широких экранах оглавление всегда видно, а ссылка на текущий раздел выделена синим цветом.](navigation-4.png)
...
![Хлебные крошки, указывающие путь к текущей странице.](navigation-5.png)
...
![В локальной навигации рядом с названием этой главы стоит галочка.](navigation-6.png)
...
![A well-contrasted navigation header, with a white picker on a black background.](navigation-7.png)

---

![A poorly-contrasted navigation header, with a black picker on a grey background.](navigation-8.png)
