...
![Три фоторамки, расположенные рядом друг с другом. На средней рамке сверху нарисованы секции модели блока](borders-1.png)
...
<figure markdown>
![Границы отображаются в браузерах Chrome, Firefox и Safari.](borders-2.png)
...
![Изображение, используемое в демонстрационном примере, с четырьмя срезами, показанными синими линиями](borders-3.png)
...
:material-information-outline: Источник: [Borders](https://web.dev/learn/css/borders/)
